  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (cadet) {
        ...
        setErrorMsg(`Cadet ID "${cleanId}" was not found in the CSU ROTC Roster. Please verify your ID number or report to your Platoon Sergeant.`);
      }
    } catch (err) {
      console.error('Login error:', err);
      setErrorMsg('Unable to verify Cadet ID at this time. Please check your internet connection.');
    } finally {
      setLoading(false);
    }
  };
