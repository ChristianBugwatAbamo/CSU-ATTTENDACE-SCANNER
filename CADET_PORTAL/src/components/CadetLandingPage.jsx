...
export default function CadetLandingPage({ onOpenLogin }) {
  ...
  return (
    ...
    >
      {/* Tactical Radar Overlay for Cadet Portal navigation */}
      {isNavigating && (
        <MilitaryLoader
          mode="cadet"
          variant="fullscreen"
      ...
      <style>{`
        ...
        .cadet-seals-scroll-container::-webkit-scrollbar {
          display: none;
        }
        .cadet-seals-row {
          display: flex;
        ...
        @media (max-width: 648px) {
          ...
          .cadet-hero-section {
            ...
            padding: 1rem 0.5rem 1.25rem 0.5rem !important;
            display: flex !important;
            flex-direction: column !important;
            justify-content: center !important;
            align-items: center !important;
          ...
          .cadet-seals-scroll-container {
            ...
            padding: 1.5rem 0.5rem 0.5rem 0.5rem !important; /* pt-6 px-2 */
            overflow: visible !important;
            display: flex !important;
            align-items: center !important;
            justify-content: center !important;
          ...
          /* Mobile side seals: w-8 h-8 (32px / 2rem), sm:w-12 sm:h-12 (48px / 3rem) */
          .cadet-seal-outer,
          .cadet-seal-mid,
          .cadet-seal-side {
          ...
          /* Main ROTC seal: w-28 h-28 (112px / 7rem), sm:w-36 sm:h-36 (144px / 9rem) */
          .cadet-seal-center {
            width: 7rem !important;  /* w-28 (112px) */
            height: 7rem !important; /* h-28 (112px) */
        ...
        @media (min-width: 480px) and (max-width: 648px) {
          ...
          .cadet-seal-mid,
          .cadet-seal-side {
            width: 3rem !important;  /* sm:w-12 (48px) */
            height: 3rem !important; /* sm:h-12 (48px) */
            padding: 3px !important;
          }
          .cadet-seal-center {
            width: 9rem !important;  /* sm:w-36 (144px) */
            height: 9rem !important; /* sm:h-36 (144px) */
      ...
      {/* ========================================================================= */}
      <section
        className="cadet-hero-section min-h-screen py-2"
        style={{
      ...
      >
        ...
        <div style={{ maxWidth: '840px', margin: 'auto', position: 'relative', zIndex: 1, width: '100%' }}>
          {/* 5-Logo Horizontal Container */}
          <div
            className="cadet-seals-scroll-container w-full max-w-full px-2 flex items-center justify-center mt-2 mb-3"
            style={{
              width: '100%',
              maxWidth: '100%',
              overflow: 'visible',
          ...
          >
            <div
              className="cadet-seals-row w-full max-w-full flex items-center justify-center"
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
                gap: 'clamp(0.25rem, 1.8vw, 1.4rem)',
                flexWrap: 'nowrap',
                width: '100%',
                maxWidth: '100%',
                margin: '0 auto',
            ...
            >
              ...
              <div
                ...
                className="cadet-seal-outer cadet-seal-side"
                style={{
              ...
              <div
                ...
                className="cadet-seal-mid cadet-seal-side"
                style={{
                  width: 'clamp(70px, 9.5vw, 112px)',
                  height: 'clamp(70px, 9.5vw, 112px)',
                  borderRadius: '50%',
                  background: 'linear-gradient(135deg, rgba(6, 78, 46, 0.6) 0%, rgba(3, 43, 25, 0.8) 100%)',
          ...
          {/* Official Badge Pill */}
          <div
            className="cadet-badge-pill mb-3"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '6px',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '0.5rem' }}>
            <button
              ...
              onClick={() => navigateWithLoader('Verifying Cadet Credentials...', onOpenLogin)}
              style={{
