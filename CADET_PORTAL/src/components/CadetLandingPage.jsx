      ...
      {isNavigating && (
        ...
        @media (max-width: 648px) {
          ...
          .cadet-hero-section {
            ...
            padding: 2rem 0.75rem 2.5rem 0.75rem !important;
            display: flex !important;
            flex-direction: column !important;
            justify-content: center !important;
            align-items: center !important;
          ...
          .cadet-seals-scroll-container {
            padding: 0.75rem 0.25rem 1.25rem 0.25rem !important;
      ...
      `}</style>
        ...
        >
          ...
          <div style={{ maxWidth: '840px', margin: 'auto', position: 'relative', zIndex: 1, width: '100%' }}>
            {/* 5-Logo Horizontal Scroll Container */}
            <div
              className="cadet-seals-scroll-container"
              style={{
                width: '100%',
                overflowX: 'auto',
                overflowY: 'visible',
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    height: 'clamp(145px, 20vw, 225px)',
                    borderRadius: '50%',
                    background: 'linear-gradient(135deg, #064e2e 0%, #032b19 100%)',
                    border: '4.5px solid #e5a900',
                    boxShadow: '0 12px 32px rgba(0, 0, 0, 0.6), 0 0 24px rgba(229, 169, 0, 0.45)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    padding: '12px',
                ...
                >
                  <img
                    ...
                    style={{
                      ...
                      height: '100%',
                      objectFit: 'contain',
                      filter: 'drop-shadow(0 0 20px rgba(250, 204, 21, 0.85)) drop-shadow(0 0 8px rgba(229, 169, 0, 0.9)) drop-shadow(0 6px 14px rgba(0, 0, 0, 0.5))'
                    }}
                    onError={(e) => { e.target.style.display = 'none'; }}
                  />
                </div>
